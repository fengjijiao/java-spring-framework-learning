package us.fjj.spring.learning.springandmybatisusage.method1;
...
public class MainConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactoryBean(DataSource dataSource) throws IOException {
        ...
        //获取所有mapper.xml文件
        Resource[] resources = new PathMatchingResourcePatternResolver().getResources("classpath:resources/mapper/*.xml");
